...
norm_name_allc = set(feats_dfs.columns) & set(norm_name_all)

notnorm_name_allc = set(feats_dfs.columns) & set(notnorm_name_all)

not_norm_all = feats_dfs.drop(norm_name_allc,axis=1)

norm_all = feats_dfs.drop(notnorm_name_allc,axis=1)
...
# Names of files
csv_filenames = {
    'ravdess pca ica/norm_all.csv': norm_all,
    'ravdess pca ica/not_norm_all.csv': not_norm_all,
    'ravdess pca ica/pca_all.csv': PCA_comp_all,
    'ravdess pca ica/pca_normal.csv': PCA_comp_norm_all,
    'ravdess pca ica/pca_not_normal.csv': PCA_comp_not_norm_all,
    # adicione mais arquivos CSV conforme necessário
}
