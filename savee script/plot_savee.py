# -*- coding: utf-8 -*-
"""
Created on Wed Apr 17 17:56:55 2024
...
excel_filename = r'savee_pca_ica.xlsx'
...
# Define the Excel filename
excel_filename = r'savee_pca_ica_kw.xlsx'
...
emotions = emotions.drop(['file'],axis=1)
...
plotheat(pca_ica_matrix_a, 9, 'Heatmap_distribuition_separated_Savee.png', True, 0.5)

plotheat(pca_ica_matrix_all, 9, 'Heatmap_distribuition_not_separated_Savee.png', True, 0.5)



plotheat(pca_ica_matrix_a, 9, 'Heatmap_distribuition_separated2_Savee.png' , False, 0)

plotheat(pca_ica_matrix_all, 9, 'Heatmap_distribuition_not_separated2_Savee.png' , False, 0)
...
plotheat(pca_ica_matrix_a_kw, 9, 'Heatmap_distribuition_separated_Savee_kw.png', True, 0.5)

plotheat(pca_ica_matrix_all_kw, 9, 'Heatmap_distribuition_not_separated_Savee_kw.png', True, 0.5)



plotheat(pca_ica_matrix_a_kw, 9, 'Heatmap_distribuition_separated2_Savee_kw.png' , False, 0)

plotheat(pca_ica_matrix_all_kw, 9, 'Heatmap_distribuition_not_separated2_Savee_kw.png' , False, 0)
...
def results(ica_feats, pca_feats, labels, n_folds):
    ...
    print(classification_report(labels.values.ravel(), pred))
...
plt.show()
plt.rcParams['savefig.dpi']=600
plt.savefig('Savee_i60_p50.png', format='png')
...
plt.tight_layout()
plt.rcParams['savefig.dpi']=600
plt.savefig('Savee cm60i_50p_sep_kw.png', format='png')
...
plt.tight_layout()
plt.rcParams['savefig.dpi']=600
plt.savefig('Savee cm60i_50p_not_sep_kw.png', format='png')
